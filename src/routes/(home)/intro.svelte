...
{#if more}
  <div class="more" aria-live="polite">
    <Typewriter
      text={[
        "I'm a seasoned developer with more than 10 years on the field blending the art of design with programming skill to deliver an immersive, engaging and efficient user experience through best coding practices, proactive feature optimization and relentless debugging.",
